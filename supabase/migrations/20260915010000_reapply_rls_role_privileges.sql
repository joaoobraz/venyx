-- Reaplica 20260820023000_restore_rls_role_privileges, que nunca chegou a rodar
-- em produção. Sem ela, anon/authenticated ficaram sem privilégio nenhum de
-- tabela: salvar bio, salvar planos e publicar post/story falhavam com
-- "permission denied" mesmo com as políticas de RLS corretas. Descoberto no
-- primeiro teste real com conta de criadora, em 15/09/2026.
--
