...
const dictionaries: Record<Exclude<Locale, "es">, Dict> = {
  "pt-BR": {
    ...
    "nav.welcome": "Boas-vindas automáticas",
    "nav.topFans": "Top fãs",
    "nav.linkTree": "Fanlira Links",
    "nav.gifts": "Lista de Mimos",
    "nav.requests": "Pedidos personalizados",
  ...
  en: {
    ...
    "nav.welcome": "Auto welcome message",
...
const spanishDictionary: Dict = {
  ...
  "nav.welcome": "Bienvenida automática",
  "nav.topFans": "Top fans",
  "nav.linkTree": "Fanlira Links",
  "nav.gifts": "Lista de regalos",
  "nav.requests": "Pedidos personalizados",
  "nav.myrequests": "Mis pedidos",
